...
const OrderForm = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!order.customer.email.trim()) {
      ...
      newErrors.customer = { ...newErrors.customer, email: "Email is invalid" };
    }

    // Validate items
    if (!order.items[0].amount.trim()) {
      newErrors.items = { ...newErrors.items, amount: "Amount is required" };
    ...
    if (!order.poi_payment_settings.devices_serial_number.trim()) {
      newErrors.devices_serial_number = "Device serial number is required";
    }
    ...
    return (
      ...
      (!newErrors.customer || Object.keys(newErrors.customer).length === 0) &&
    ...
    <div className={styles.container}>
      <div className={styles.content}>
        <div className={styles.images}>
          ...
          <img src="/blackbird.svg" alt="Blackbird Logo" />
        </div>
        ...
        <div className={styles.form}>
          ...
          <form onSubmit={handleSubmit} className={styles.formContainer}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.field}>
                <input
                  ...
                  className={`${styles.input} ${
                    errors.customer?.name ? styles.inputError : ""
                  }`}
              ...
              <div className={styles.field}>
                <input
                  ...
                  onChange={handleCustomerChange}
                  className={`${styles.input} ${
                    errors.customer?.email ? styles.inputError : ""
                  }`}
                  disabled={status === "loading"}
                />
            ...
            <div className={styles.section}>
              <h2 className={styles.sectionTitle}>Item Information</h2>
              ...
              <div className={styles.field}>
                <input
                  ...
                  className={`${styles.input} ${
                    errors.items?.amount ? styles.inputError : ""
                  }`}
                  min="0"
                  step="0.01"
                  disabled={status === "loading"}
              ...
              <div className={styles.field}>
                <input
                  ...
                  onChange={(e) => handleItemChange(e, 0)}
                  className={`${styles.input} ${
                    errors.items?.description ? styles.inputError : ""
                  }`}
                  disabled={status === "loading"}
                />
              ...
              <div className={styles.field}>
                <input
                  ...
                  onChange={(e) => handleItemChange(e, 0)}
                  className={`${styles.input} ${
                    errors.items?.quantity ? styles.inputError : ""
                  }`}
                  min="1"
                  disabled={status === "loading"}
                />
            ...
            <div className={styles.section}>
              ...
              <div className={styles.field}>
                <input
                  ...
                  value={order.poi_payment_settings.devices_serial_number}
                  onChange={handleInputChange}
                  className={`${styles.input} ${
                    errors.devices_serial_number ? styles.inputError : ""
                  }`}
                  disabled={status === "loading"}
                />
              ...
              <div className={styles.field}>
                <label className={styles.label}>Print Order Receipt:</label>
                  ...
                  <div className={styles.radioGroup}>
                    <label>
                      <input
                        ...
                        value="true"
                        checked={
                          order.poi_payment_settings.print_order_receipt ===
                          true
                        }
                  ...
                  <div className={styles.radioGroup}>
                    <label>
                      <input
                        ...
                        name="visible"
                        value="true"
                        checked={order.poi_payment_settings.visible === true}
                        onChange={handleRadioChange}
                        disabled={status === "loading"}
                      />
                      Yes
                  ...
                  <div className={styles.radioGroup}>
                    <label>
                      <input
                        ...
                        name="visible"
                        value="false"
                        checked={order.poi_payment_settings.visible === false}
                        onChange={handleRadioChange}
                        disabled={status === "loading"}
                      />
                      No
            ...
            <div className={styles.section}>
              ...
              <div className={styles.field}>
                <label className={styles.label}>Installment Type:</label>
                <select
